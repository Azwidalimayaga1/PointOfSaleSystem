...
class ProductAdapter(private val onClick: (Product) -> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ViewProductItemBinding.inflate(
    ...
    inner class ViewHolder(private val binding: ViewProductItemBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(product: Product) {
            binding.productName.text = product.name
            binding.productBarcode.text = "Barcode: ${product.barcode}"
            binding.productCategory.text = product.category ?: "No category"
